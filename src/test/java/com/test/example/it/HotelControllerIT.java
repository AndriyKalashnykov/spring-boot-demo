...
class HotelControllerIT {
    ...
    void postCreateRetrieveDeleteRoundTrip() {
        ...
        ResponseEntity<Hotel> getResponse = restTemplate.exchange(
                location, HttpMethod.GET, jsonRequest(null), Hotel.class);
        ...
        ResponseEntity<String> afterDelete = restTemplate.exchange(
                location, HttpMethod.GET, jsonRequest(null), String.class);
    ...
    void putWithMismatchedIdReturns400() {
        ...
        ResponseEntity<String> response = restTemplate.exchange(
                location, HttpMethod.PUT, jsonRequest(updated), String.class);
    ...
    private URI create(Hotel payload) {
        ResponseEntity<Void> createResponse = restTemplate.exchange(
                HOTELS_PATH, HttpMethod.POST, jsonRequest(payload), Void.class);
